...
// Add the actual data array here
export const data: SkiData[] = [
  {
    "id": 0,
    "saison": "été",
    "prix": 351,
...
export const seasons = ["été", "hiver", "printemps", "automne"] as const;
export const levels = ["novice", "moyen", "pro"] as const;
